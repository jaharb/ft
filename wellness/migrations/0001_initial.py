    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='wellness.author')),
            ],
        ),
        migrations.CreateModel(
            name='Genre',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, to='wellness.book')),
            ],
            options={
                'ordering': ['due_back'],
            },
        ...
        migrations.AddField(
            model_name='book',
            name='genre',
            field=models.ManyToManyField(help_text='Select a genre for this book', to='wellness.Genre'),
        ),
    ]
